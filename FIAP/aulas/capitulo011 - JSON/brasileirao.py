...
def nome_do_time(dados,id_numerica):
   time_nome = dados['equipes'][id_numerica]['nome-comum']
   return time_nome
...
def qtos_libertadores(dados):
    ...
    numero_de_times = int(faixa.split('-')[1])
    return numero_de_times
...
def ids_dos_melhor_classificados(dados,numero_de_times):
    ...
    for id in range(0, numero_de_times):
        melhores = dados['fases']['2700']['classificacao']['grupo']['Único'][id]
        lista_melhores.append(melhores)
