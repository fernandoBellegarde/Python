...
Se a árvore a esquerda for vazia, pode devolver ela mesma.

Se não houver arvore à esquerda, sua funcao deve retornar a string 'esquerda vazia'
'''
...
O proximo passo:
    ...
    TODO: cuidado, se a raiz não tiver um filho a esquerda, a resposta correta é a própria raiz
...
A gente não viu isso ainda, mas vou te apresentar agora
'''
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_101_arvore_esquerda(self):
        ...
        self.assertEqual(arvore_esquerda({}), "esquerda vazia")
